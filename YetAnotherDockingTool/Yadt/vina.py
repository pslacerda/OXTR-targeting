...
def load_vina_results(project_file, group, max_load, max_rank, interactions_check):
    ...
    for pose in results:
        ...
        cmd.set_name(obj_name, obj_name)
...
def new_load_results_widget():
    ...
    layout.addRow("Interactions:", interactions_check)
...
class VinaThread(BaseThread):
    def run(self):
        ...
        max = np.max(box_coords, axis=0) + float(box_margin)
        min = np.min(box_coords, axis=0) - float(box_margin)
...
def new_run_docking_widget():
    ...
    def validate_box_sel():
        ...
        try:
            ...
            cmd.delete("_box")
            return False
        display_box_sel("_box", text)
        box_sel.setPalette(palette)
        return True

    box_spin = QDoubleSpinBox(widget)
    box_spin.setRange(0.0, 99.0)
    box_spin.setValue(4.0)
    box_spin.setSingleStep(0.1)
    box_spin.setDecimals(1)
    ...
    layout.addRow("Box margin:", box_spin)
...
def __init_plugin__(app=None):
    ...
    DEFAULT_PREFS = {
        ...
        "DOCKING_ADT_PYTHON": "/home/peu/Apps/mgltools_x86_64Linux2_1.5.7/bin/pythonsh",
        "DOCKING_PREPARE_RECEPTOR": "/home/peu/Apps/mgltools_x86_64Linux2_1.5.7/MGLToolsPckgs/AutoDockTools/Utilities24/prepare_receptor4.py",
        "DOCKING_PREPARE_FLEXRECEPTOR": "/home/peu/Apps/mgltools_x86_64Linux2_1.5.7/MGLToolsPckgs/AutoDockTools/Utilities24/prepare_flexreceptor4.py",
    }
